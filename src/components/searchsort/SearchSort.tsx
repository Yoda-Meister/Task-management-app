...
import { SortMethod, tasksActions } from '../../store/tasks';
...
const SearchSort: FC<{ searchValue: string }> = (props) => {
	...
	const searchHandler = (event: ChangeEvent<HTMLInputElement>) => {
		dispatch(tasksActions.setSearchText(event.target.value));
	};

	const sortHandler = (sort: SortMethod) => {
		dispatch(tasksActions.setSortMethod(sort));
	};
	...
	return (
		<div className="flex items-center justify-between">
			...
			<div className="relative text-gray-400 dark:text-gray-400 focus-within:text-gray-600 dark:focus-within:text-gray-200 w-full mr-2 sm:mr-2 md:mr-5 lg:mr-5">
				...
				<input
					id="search"
					className="block w-full bg-white dark:bg-gray-700 py-2 pl-10 pr-3 border-gray-300 dark:border-transparent rounded-md leading-5 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-blue-600 dark:focus:ring-offset-blue-400 focus:ring-white dark:focus:ring-transparent focus:border-white sm:text-sm"
			...
			<Menu as="div" className="relative">
				<Menu.Button className="w-full bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-700 dark:hover:border-gray-900 rounded-md shadow-sm px-4 py-2 inline-flex justify-center text-sm font-medium text-gray-700 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-blue-400">
									...
									>
										<b>
											<FormattedMessage
												...
												description="A way of sorting the task list"
											/>
										</b>
										<p>
											<FormattedMessage
